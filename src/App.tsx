...
export default function App() {
  ...
  const navItems = [
    ...
    { to: '/streamings', label: 'Streamings', icon: icons.streamings },
      ...
      `}>
        ...
        <div className="p-4 border-b border-blue-700">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl">tudo no azul</span>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-blue-700">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-red-300 hover:bg-red-600/20 hover:text-red-200 transition-all duration-200"
          >
            {icons.logout}
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="lg:hidden bg-white border-b border-gray-200 shadow-sm">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <span className="font-semibold text-blue-600">tudo no azul</span>
