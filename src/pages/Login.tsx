          ...
          <form onSubmit={submit} className="grid gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  className="w-full border border-dark-border bg-dark-surface text-gray-100 rounded-lg pl-10 pr-24 sm:pr-28 py-2.5 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-500"
                  value={password}
            ...
            <div className="text-center text-xs text-gray-400">
              Não tem conta? <Link to="/register" className="text-blue-400 hover:text-blue-300 font-medium">Cadastre-se</Link>
            </div>
          </form>
        </div>
      </div>
